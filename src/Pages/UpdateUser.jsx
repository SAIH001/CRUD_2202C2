...
const UpdateUser = () => {
    ...
    useEffect(() => {
      ...
      async function getUserData(){
        const SingleUser = await fetch(`https://66dfe57b2fb67ac16f277421.mockapi.io/aptechnn/userAccount/${id}`);
        ...
        setUserName(singleUserData.userName);
        setUserEmail(singleUserData.userEmail);
        setUserRole(singleUserData.userRole);
        setUserPassword(singleUserData.userPassword);
            ...
            if (UserCPassword != null && UserCPassword.length > 3) {
              ...
              if (UserPassword == UserCPassword) {
                ...
                try {
                  ...
                  const Response = await fetch(`https://66dfe57b2fb67ac16f277421.mockapi.io/aptechnn/userAccount/${id}`, {
                    method: 'PUT',
            ...
            <div className="col-12 col-md-9 col-lg-7 col-xl-6">
              <div className="card" style={{ borderRadius: "15px;" }}>
                <div className="card-body p-5">
                  <h2 className="text-uppercase text-center mb-5">Update User Account</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div data-mdb-input-init className="form-outline mb-4">
                      ...
                      <input type="text" id="form3Example1cg"  value={UserName}  className="form-control form-control-lg" onChange={(e) => setUserName(e.target.value)} />
                    </div>

                    <div data-mdb-input-init className="form-outline mb-4">
                      <label className="form-label" htmlFor="form3Example3cg">Your Email</label>
                      <input type="email" id="form3Example3cg"  value={UserEmail}  className="form-control form-control-lg" onChange={(e) => setUserEmail(e.target.value)} />
                    </div>

                    <div data-mdb-input-init className="form-outline mb-4">
                      <label className="form-label" htmlFor="form3Example4cg">Password</label>
                      <input type="text" id="form3Example4cg" value={UserPassword} className="form-control form-control-lg" onChange={(e) => setUserPassword(e.target.value)} />
                    </div>
                    ...
                    <div className="d-flex justify-content-center">
                      <button type="submit" data-mdb-button-init
                        data-mdb-ripple-init className="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Update User</button>
                    </div>
